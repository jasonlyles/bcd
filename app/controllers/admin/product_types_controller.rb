...
class Admin::ProductTypesController < AdminController
  ...
  def create
    ...
    if @product_type.save
      redirect_to [:admin, @product_type], notice: 'Product type was successfully created.'
    else
      render 'new'
    end
  end
  ...
  def destroy
    ...
    redirect_to admin_product_types_url, notice: 'Product type was successfully destroyed.'
  end
