class AuthenticationsController < ApplicationController
  before_filter :authenticate_user!, except: %i[create clear_authentications failure]
  skip_before_filter :find_cart, only: %i[create failure]
  ...
  def create
    ...
    if authentication && authentication.user.account_status == 'cancelled'
