...
describe "products/index.html.haml" do
  before(:each) do
    ...
    @products.stub(:current_page).and_return(1)
    @products.stub(:total_pages).and_return(1)
    @products.stub(:num_pages).and_return(1)
    @products.stub(:limit_value).and_return(2)
  end
